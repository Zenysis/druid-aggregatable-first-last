...
/**
 * Run the provided aggregation over the values with the smallest corresponding
 * timestamp.
 */
@JsonTypeName("aggregateFirst")
public class AggregateFirstAggregatorFactory extends FirstLastAggregatorFactory
{
  public static final byte CACHE_TYPE_ID = 0x78;

  public AggregateFirstAggregatorFactory(
  ...
  {
    return "AggregateFirstAggregatorFactory{" +
           "delegate=" + delegate +
           ", name='" + name + '\'' +
           '}';
  }
